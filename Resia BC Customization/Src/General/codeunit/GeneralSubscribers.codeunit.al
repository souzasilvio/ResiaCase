codeunit 50103 "General Event Subscribers"
{
    SingleInstance = true;
    ...
    begin
        ...
        if Customer.Get(CustCode) then begin
            if Customer."Customer Category Code" <> '' then begin
                CustomerCategory.Get(Customer."Customer Category Code");
    ...
    begin
        if Rec."Entry Type" = Rec."Entry Type"::Sale then begin
            if Customer.Get(Rec."Source No.") then begin
                Rec."Customer Category Code" := Customer."Customer Category Code";
                Rec.Modify();
            end;
        end;
    end;
    ...
    var
        VendorQuality: Record "Vendor Quality";
