codeunit 50106 "Gift Management"
{
    ...
    begin
        ...
        GiftCampaign.SetRange(CustomerCategoryCode, Customer."Customer Category Code");
    ...
    local procedure DoGiftCheck(var SalesLine: Record "Sales Line"; var GiftCampaign: Record "Gift Campaign"; var Handled: Boolean)
    var
