codeunit 50102 "Vendor Quality Mgt"
{
    procedure CalculateVendorRate(var VendorQuality: Record "Vendor Quality")
    var
        Handled: Boolean;
    begin
    ...
    local procedure VendorRateCalculation(var VendorQuality: Record "Vendor Quality"; var Handled: Boolean)
    begin
        if Handled then
            exit;
    ...
    procedure UpdateVendorQualityStatistics(var VendorQuality: Record "Vendor Quality")
    var
        Year: Integer;
        DW: Dialog;
    ...
    local procedure OnBeforeCalculateVendorRate(var VendorQuality: Record "Vendor Quality"; var Handled: Boolean)
    begin
    end;

    [IntegrationEvent(true, false)]
    local procedure OnAfterCalculateVendorRate(var VendorQuality: Record "Vendor Quality")
    begin
    end;
}